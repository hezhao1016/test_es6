...
var xiaohong2 = new Student2('小红2');

console.log('------------------------------');
xiaohong.hello(); // Hi, 小红!
console.log(xiaohong instanceof Student2);
console.log(xiaohong.hello === xiaohong2.hello);
...
console.log('------------------------------');
console.log(`${xiaoqiang.name}在读${xiaoqiang.grade}年级`); // 1
xiaoqiang.hello();
console.log(xiaoqiang instanceof Student3);
